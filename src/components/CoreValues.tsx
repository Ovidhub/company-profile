const values = [
  ...
  {
    title: "Innovation",
    description: "We embrace creativity and forward-thinking to solve modern challenges.",
    icon: (
      <svg className="w-8 h-8" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
...
export default function CoreValues() {
  return (
    <section className="py-20 sm:py-28 bg-gradient-to-br from-gray-custom to-white relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="grid md:grid-cols-3 gap-8">
          {values.map((value, index) => (
            ...
            >
              <div className="w-16 h-16 rounded-xl bg-primary/10 text-primary flex items-center justify-center mb-6 group-hover:bg-primary group-hover:text-white transition-all duration-300">
                {value.icon}
              </div>
